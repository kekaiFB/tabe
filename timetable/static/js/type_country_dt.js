$(document).ready(function () {
    ...
    $('#type_country_dt thead tr')
    .clone(true)
    .addClass('filters-city')
    .appendTo('#type_country_dt thead');
    var type_country_dt = $('#type_country_dt').DataTable({
            "dom": 'ftipr',
             //--------------------Память фильторв---------------------------
             stateSave: true,
             select: true,
            ...
            //Сбросить фильтры
    $('#type_country_dt-resetFilter').on('click', function (e) {
        type_country_dt_resetFilters()
    });



    function type_country_dt_resetFilters() {
        type_country_dt.state.clear();
        location.reload()
    } 
});
