$(document).ready(function () {
    ...
    $('#timetableStatus_dt thead tr')
    .clone(true)
    .addClass('filters-city')
    .appendTo('#timetableStatus_dt thead');
    var timetableStatus_dt = $('#timetableStatus_dt').DataTable({
            "dom": 'ftipr',
             //--------------------Память фильторв---------------------------
             stateSave: true,
             select: true,
            ...
            //Сбросить фильтры
    $('#timetableStatus_dt-resetFilter').on('click', function (e) {
        timetableStatus_dt_resetFilters()
    });



    function timetableStatus_dt_resetFilters() {
        timetableStatus_dt.state.clear();
        location.reload()
    } 
});
